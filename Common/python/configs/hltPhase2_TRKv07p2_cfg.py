...
from JMETriggerAnalysis.Common.customizeHLTForPhase2 import customise_hltPhase2_scheduleJMETriggers_TRKv07p2 

#call to customisation function customise_hltPhase2_scheduleJMETriggers_TRKv07p2 imported from JMETriggerAnalysis.Common.customizeHLTForPhase2
process = customise_hltPhase2_scheduleJMETriggers_TRKv07p2(process)
