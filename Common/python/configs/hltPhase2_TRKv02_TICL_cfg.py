...
# with command line options: step3 --geometry Extended2026D49 --era Phase2C9 --conditions 111X_mcRun4_realistic_T15_v5 --processName HLTX --step RAW2DIGI,RECO --eventcontent RECO --datatier RECO --filein /store/mc/Phase2HLTTDRSummer20ReRECOMiniAOD/TT_TuneCP5_14TeV-powheg-pythia8/FEVT/PU200_111X_mcRun4_realistic_T15_v1-v2/280000/015FB6F1-59B4-304C-B540-2392A983A97D.root --mc --nThreads 4 --nStreams 4 --no_exec -n 10 --customise SLHCUpgradeSimulations/Configuration/aging.customise_aging_1000,Configuration/DataProcessing/Utils.addMonitoring --customise JMETriggerAnalysis/Common/customizeHLTForPhase2.customise_hltPhase2_scheduleJMETriggers_TRKv02_TICL --python_filename /afs/cern.ch/work/m/missirol/private/jmeTrigger/phase2/CMSSW_11_1_8/src/JMETriggerAnalysis/Common/python/configs/hltPhase2_TRKv02_TICL_cfg.py
import FWCore.ParameterSet.Config as cms

from Configuration.Eras.Era_Phase2C9_cff import Phase2C9

process = cms.Process('HLTX',Phase2C9)
...
from JMETriggerAnalysis.Common.customizeHLTForPhase2 import customise_hltPhase2_scheduleJMETriggers_TRKv02_TICL 

#call to customisation function customise_hltPhase2_scheduleJMETriggers_TRKv02_TICL imported from JMETriggerAnalysis.Common.customizeHLTForPhase2
process = customise_hltPhase2_scheduleJMETriggers_TRKv02_TICL(process)
