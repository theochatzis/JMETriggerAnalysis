...
from JMETriggerAnalysis.Common.customizeHLTForPhase2 import customise_hltPhase2_scheduleJMETriggers_TRKv06p1 

#call to customisation function customise_hltPhase2_scheduleJMETriggers_TRKv06p1 imported from JMETriggerAnalysis.Common.customizeHLTForPhase2
process = customise_hltPhase2_scheduleJMETriggers_TRKv06p1(process)
