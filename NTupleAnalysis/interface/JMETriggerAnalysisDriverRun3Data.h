#ifndef NTupleAnalysis_JMETrigger_JMETriggerAnalysisDriverRun3Data_h
#define NTupleAnalysis_JMETrigger_JMETriggerAnalysisDriverRun3Data_h

#include <map>

#include <JMETriggerAnalysis/NTupleAnalysis/interface/JMETriggerAnalysisDriverData.h>

class JMETriggerAnalysisDriverRun3Data : public JMETriggerAnalysisDriverData {

 public:
  explicit JMETriggerAnalysisDriverRun3Data(const std::string& outputFilePath="", const std::string& outputFileMode="recreate");
  explicit JMETriggerAnalysisDriverRun3Data(const std::string& tfile, const std::string& ttree, const std::string& outputFilePath, const std::string& outputFileMode="recreate");
  ~JMETriggerAnalysisDriverRun3Data() {}

  void init() override;
  void analyze() override;

 protected:
  bool jetBelongsToCategory(const std::string& jetCollection ,const std::string& categLabel, const float jetPt, const float jetAbsEta, const float jetPhi, const float jetEta) const override;
