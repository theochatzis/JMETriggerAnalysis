...
#    print '\033[1m'+_tmpReco+'\033[0m'
    ...
    for _tmpReco in recoKeys:
      ...
      for _tmpJetThresh in ['140', '320', '500']:
        effysJet[_tmpReco][_tmpJetThresh] = getJetEfficiencies(
          fpath = inputDir+_tmpReco+'/harvesting/'+_tmpReco+'/Run3Winter20_QCD_PtFlat15to3000_14TeV_'+_tmpPU+'.root',
    ...
    for _tmpRef in [
      ...
      for _tmpType in [
        ...
        try:
          effysJet['25June_withThreshold']['140'][_tmpType+'_SingleJet_wrt_'+_tmpRef].SetMarkerSize(1)
          effysJet['25June_withThreshold']['140'][_tmpType+'_SingleJet_wrt_'+_tmpRef].SetLineWidth(2)
          effysJet['25June_withThreshold']['140'][_tmpType+'_SingleJet_wrt_'+_tmpRef].SetMarkerColor(1)
          effysJet['25June_withThreshold']['140'][_tmpType+'_SingleJet_wrt_'+_tmpRef].SetLineColor(1)
          effysJet['25June_withThreshold']['140'][_tmpType+'_SingleJet_wrt_'+_tmpRef].SetLineStyle(1)
          effysJet['25June_withThreshold']['140'][_tmpType+'_SingleJet_wrt_'+_tmpRef].Draw('lepz')

          effysJet['25June_withThreshold']['320'][_tmpType+'_SingleJet_wrt_'+_tmpRef].SetMarkerSize(1)
          effysJet['25June_withThreshold']['320'][_tmpType+'_SingleJet_wrt_'+_tmpRef].SetLineWidth(2)
          effysJet['25June_withThreshold']['320'][_tmpType+'_SingleJet_wrt_'+_tmpRef].SetMarkerColor(2)
          effysJet['25June_withThreshold']['320'][_tmpType+'_SingleJet_wrt_'+_tmpRef].SetLineColor(2)
          effysJet['25June_withThreshold']['320'][_tmpType+'_SingleJet_wrt_'+_tmpRef].SetLineStyle(1)
          effysJet['25June_withThreshold']['320'][_tmpType+'_SingleJet_wrt_'+_tmpRef].Draw('lepz')

          effysJet['25June_withThreshold']['500'][_tmpType+'_SingleJet_wrt_'+_tmpRef].SetMarkerSize(1)
          effysJet['25June_withThreshold']['500'][_tmpType+'_SingleJet_wrt_'+_tmpRef].SetLineWidth(2)
          effysJet['25June_withThreshold']['500'][_tmpType+'_SingleJet_wrt_'+_tmpRef].SetMarkerColor(4)
          effysJet['25June_withThreshold']['500'][_tmpType+'_SingleJet_wrt_'+_tmpRef].SetLineColor(4)
          effysJet['25June_withThreshold']['500'][_tmpType+'_SingleJet_wrt_'+_tmpRef].SetLineStyle(1)
          effysJet['25June_withThreshold']['500'][_tmpType+'_SingleJet_wrt_'+_tmpRef].Draw('lepz')
        except: pass

        try:
          effysJet['25June_HLT_Run3TRK']['140'][_tmpType+'_SingleJet_wrt_'+_tmpRef].SetMarkerSize(1)
          effysJet['25June_HLT_Run3TRK']['140'][_tmpType+'_SingleJet_wrt_'+_tmpRef].SetLineWidth(2)
          effysJet['25June_HLT_Run3TRK']['140'][_tmpType+'_SingleJet_wrt_'+_tmpRef].SetMarkerColor(1)
          effysJet['25June_HLT_Run3TRK']['140'][_tmpType+'_SingleJet_wrt_'+_tmpRef].SetLineColor(1)
          effysJet['25June_HLT_Run3TRK']['140'][_tmpType+'_SingleJet_wrt_'+_tmpRef].SetLineStyle(2)
          effysJet['25June_HLT_Run3TRK']['140'][_tmpType+'_SingleJet_wrt_'+_tmpRef].Draw('lepz')

          effysJet['25June_HLT_Run3TRK']['320'][_tmpType+'_SingleJet_wrt_'+_tmpRef].SetMarkerSize(1)
          effysJet['25June_HLT_Run3TRK']['320'][_tmpType+'_SingleJet_wrt_'+_tmpRef].SetLineWidth(2)
          effysJet['25June_HLT_Run3TRK']['320'][_tmpType+'_SingleJet_wrt_'+_tmpRef].SetMarkerColor(2)
          effysJet['25June_HLT_Run3TRK']['320'][_tmpType+'_SingleJet_wrt_'+_tmpRef].SetLineColor(2)
          effysJet['25June_HLT_Run3TRK']['320'][_tmpType+'_SingleJet_wrt_'+_tmpRef].SetLineStyle(2)
          effysJet['25June_HLT_Run3TRK']['320'][_tmpType+'_SingleJet_wrt_'+_tmpRef].Draw('lepz')

          effysJet['25June_HLT_Run3TRK']['500'][_tmpType+'_SingleJet_wrt_'+_tmpRef].SetMarkerSize(1)
          effysJet['25June_HLT_Run3TRK']['500'][_tmpType+'_SingleJet_wrt_'+_tmpRef].SetLineWidth(2)
          effysJet['25June_HLT_Run3TRK']['500'][_tmpType+'_SingleJet_wrt_'+_tmpRef].SetMarkerColor(4)
          effysJet['25June_HLT_Run3TRK']['500'][_tmpType+'_SingleJet_wrt_'+_tmpRef].SetLineColor(4)
          effysJet['25June_HLT_Run3TRK']['500'][_tmpType+'_SingleJet_wrt_'+_tmpRef].SetLineStyle(2)
          effysJet['25June_HLT_Run3TRK']['500'][_tmpType+'_SingleJet_wrt_'+_tmpRef].Draw('lepz')
        except: pass
        ...
        try:
          leg1.AddEntry(effysJet['25June_withThreshold']['140'][_tmpType+'_SingleJet_wrt_'+_tmpRef], 'HLT_PFJet140 ', 'lp')
          leg1.AddEntry(effysJet['25June_withThreshold']['320'][_tmpType+'_SingleJet_wrt_'+_tmpRef], 'HLT_PFJet320 ', 'lp')
          leg1.AddEntry(effysJet['25June_withThreshold']['500'][_tmpType+'_SingleJet_wrt_'+_tmpRef], 'HLT_PFJet500 ', 'lp')
        except: pass
        leg1.Draw('same')

        try:
          _htmpPU140 = effysJet['25June_withThreshold']['500'][_tmpType+'_SingleJet_wrt_'+_tmpRef].Clone()
          _htmpPU140.SetLineColor(1)
          _htmpPU140.SetLineStyle(2)
        except: pass

        try:
          _htmpPU200 = effysJet['25June_HLT_Run3TRK']['500'][_tmpType+'_SingleJet_wrt_'+_tmpRef].Clone()
