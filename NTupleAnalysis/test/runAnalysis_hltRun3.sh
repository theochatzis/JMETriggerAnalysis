...
INPDIR=/eos/cms/store/group/dpg_trigger/comm_trigger/TriggerStudiesGroup/Upgrade/JetMET_PhaseII/JMETriggerAnalysis_run3/ntuples/hltRun3_testTRK_210604/HLT_Run3TRK/

# directory with outputs of NTupleAnalysis
OUTDIR=output_25June_HLT_Run3TRK
OUTPUTDIR=/eos/cms/store/group/phys_jetmet/pdas/25June_HLT_Run3TRK/
