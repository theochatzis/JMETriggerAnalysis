...
INPDIR=/eos/cms/store/user/chuh/jec/VBFHToInvisible_M-125_TuneCP5_13p6TeV_powheg-pythia8
INPFILE=VBFHToInvisible_M-125_TuneCP5_13p6TeV_powheg-pythia8
...
batch_monitor.py -i ${OUTDIR}/jobs -r --repe -f 500
