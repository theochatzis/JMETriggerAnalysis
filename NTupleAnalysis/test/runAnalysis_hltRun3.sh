...
INPDIR=/eos/cms/store/group/phys_jetmet/pdas/20Oct_ntuples/HLT_Run3TRK

# directory with outputs of NTupleAnalysis
OUTDIR=output_20Oct_HLT_Run3TRK
OUTPUTDIR=/eos/cms/store/group/phys_jetmet/pdas/20Oct_HLT_Run3TRK/
