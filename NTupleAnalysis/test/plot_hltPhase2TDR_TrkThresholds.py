    ...
    for _tmpMETThresh in [
      ...
      for _tmpReco in recoKeys:
        effysMET_vbfh[_tmpPU][_tmpMETThresh][_tmpReco] = getMETEfficiencies(**{
          'fpath': inputDir+'/'+_tmpReco+'/VBF_HToInvisible_14TeV_'+_tmpPU+'.root',
          ...
          for _tmpMET in [
            ...
            for _tmpHLTthr in [
              ...
              for _tmpTrgType in [
                ...
                try:
                  effysMET[_tmpPU][_tmpHLTthr]['1p00'][_tmpMET+'_'+_tmpTrgType+'_wrt_'+_tmpRef].SetMarkerSize(1)
                  effysMET[_tmpPU][_tmpHLTthr]['1p00'][_tmpMET+'_'+_tmpTrgType+'_wrt_'+_tmpRef].SetLineWidth(2)
                  effysMET[_tmpPU][_tmpHLTthr]['1p00'][_tmpMET+'_'+_tmpTrgType+'_wrt_'+_tmpRef].SetMarkerColor(ROOT.kBlack)
                  effysMET[_tmpPU][_tmpHLTthr]['1p00'][_tmpMET+'_'+_tmpTrgType+'_wrt_'+_tmpRef].SetLineColor(ROOT.kBlack)
                  effysMET[_tmpPU][_tmpHLTthr]['1p00'][_tmpMET+'_'+_tmpTrgType+'_wrt_'+_tmpRef].Draw('lepz')

                  effysMET[_tmpPU][_tmpHLTthr]['1p50'][_tmpMET+'_'+_tmpTrgType+'_wrt_'+_tmpRef].SetMarkerSize(1)
                  effysMET[_tmpPU][_tmpHLTthr]['1p50'][_tmpMET+'_'+_tmpTrgType+'_wrt_'+_tmpRef].SetLineWidth(2)
                  effysMET[_tmpPU][_tmpHLTthr]['1p50'][_tmpMET+'_'+_tmpTrgType+'_wrt_'+_tmpRef].SetMarkerColor(ROOT.kAzure+1)
                  effysMET[_tmpPU][_tmpHLTthr]['1p50'][_tmpMET+'_'+_tmpTrgType+'_wrt_'+_tmpRef].SetLineColor(ROOT.kAzure+1)
                  effysMET[_tmpPU][_tmpHLTthr]['1p50'][_tmpMET+'_'+_tmpTrgType+'_wrt_'+_tmpRef].Draw('lepz')

                  effysMET[_tmpPU][_tmpHLTthr]['2p00'][_tmpMET+'_'+_tmpTrgType+'_wrt_'+_tmpRef].SetMarkerSize(1)
                  effysMET[_tmpPU][_tmpHLTthr]['2p00'][_tmpMET+'_'+_tmpTrgType+'_wrt_'+_tmpRef].SetLineWidth(2)
                  effysMET[_tmpPU][_tmpHLTthr]['2p00'][_tmpMET+'_'+_tmpTrgType+'_wrt_'+_tmpRef].SetMarkerColor(ROOT.kViolet-6)
                  effysMET[_tmpPU][_tmpHLTthr]['2p00'][_tmpMET+'_'+_tmpTrgType+'_wrt_'+_tmpRef].SetLineColor(ROOT.kViolet-6)
                  effysMET[_tmpPU][_tmpHLTthr]['2p00'][_tmpMET+'_'+_tmpTrgType+'_wrt_'+_tmpRef].Draw('lepz')

                  effysMET[_tmpPU][_tmpHLTthr]['2p50'][_tmpMET+'_'+_tmpTrgType+'_wrt_'+_tmpRef].SetMarkerSize(1)
                  effysMET[_tmpPU][_tmpHLTthr]['2p50'][_tmpMET+'_'+_tmpTrgType+'_wrt_'+_tmpRef].SetLineWidth(2)
                  effysMET[_tmpPU][_tmpHLTthr]['2p50'][_tmpMET+'_'+_tmpTrgType+'_wrt_'+_tmpRef].SetMarkerColor(ROOT.kPink+4)
                  effysMET[_tmpPU][_tmpHLTthr]['2p50'][_tmpMET+'_'+_tmpTrgType+'_wrt_'+_tmpRef].SetLineColor(ROOT.kPink+4)
                  effysMET[_tmpPU][_tmpHLTthr]['2p50'][_tmpMET+'_'+_tmpTrgType+'_wrt_'+_tmpRef].Draw('lepz')

                  effysMET[_tmpPU][_tmpHLTthr]['3p00'][_tmpMET+'_'+_tmpTrgType+'_wrt_'+_tmpRef].SetMarkerSize(1)
                  effysMET[_tmpPU][_tmpHLTthr]['3p00'][_tmpMET+'_'+_tmpTrgType+'_wrt_'+_tmpRef].SetLineWidth(2)
                  effysMET[_tmpPU][_tmpHLTthr]['3p00'][_tmpMET+'_'+_tmpTrgType+'_wrt_'+_tmpRef].SetMarkerColor(ROOT.kOrange+7)
                  effysMET[_tmpPU][_tmpHLTthr]['3p00'][_tmpMET+'_'+_tmpTrgType+'_wrt_'+_tmpRef].SetLineColor(ROOT.kOrange+7)
                  effysMET[_tmpPU][_tmpHLTthr]['3p00'][_tmpMET+'_'+_tmpTrgType+'_wrt_'+_tmpRef].Draw('lepz')

                  effysMET[_tmpPU][_tmpHLTthr]['3p50'][_tmpMET+'_'+_tmpTrgType+'_wrt_'+_tmpRef].SetMarkerSize(1)
                  effysMET[_tmpPU][_tmpHLTthr]['3p50'][_tmpMET+'_'+_tmpTrgType+'_wrt_'+_tmpRef].SetLineWidth(2)
                  effysMET[_tmpPU][_tmpHLTthr]['3p50'][_tmpMET+'_'+_tmpTrgType+'_wrt_'+_tmpRef].SetMarkerColor(ROOT.kSpring-6)
                  effysMET[_tmpPU][_tmpHLTthr]['3p50'][_tmpMET+'_'+_tmpTrgType+'_wrt_'+_tmpRef].SetLineColor(ROOT.kSpring-6)
                  effysMET[_tmpPU][_tmpHLTthr]['3p50'][_tmpMET+'_'+_tmpTrgType+'_wrt_'+_tmpRef].Draw('lepz')
