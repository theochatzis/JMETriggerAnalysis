...
ODIR=./tuning_test_optimizedChi2_minChi2/plots
...
for recoKey in "${recoKeys[@]}"; do
  for MinNeutralPt_factor in  "${MinNeutralPt_factors[@]}"; do
    for MinNeutralPtSlope_factor in "${MinNeutralPtSlope_factors[@]}"; do
      ...
      -i ./tuning_test_applyPUCorr_False/harvester_output/HLT_Run3TRK/MinNeutralPt_0.0/MinNeutralPtSlope_0.0/Run3Winter21_QCD_Pt15to7000_14TeV_PU__0.root:'nominal SFs (offline values)':600:1:24 \
      ./tuning_test_applyPUCorr_False_tunedSFs/harvester_output/HLT_Run3TRK/MinNeutralPt_0.0/MinNeutralPtSlope_0.0/Run3Winter21_QCD_Pt15to7000_14TeV_PU__0.root:'mean values SFs':632:1:25 \
      ./tuning_test_optimizedChi2_minChi2/harvester_output/HLT_Run3TRK/MinNeutralPt_0.0/MinNeutralPtSlope_0.0/Run3Winter21_QCD_Pt15to7000_14TeV_PU__0.root:'per particle optimized SFs':814:1:26 \
      ...
      -i ./tuning_test_applyPUCorr_False/harvester_output/HLT_Run3TRK/MinNeutralPt_0.0/MinNeutralPtSlope_0.0/Run3Winter21_VBF_HToInvisible_14TeV_PU__0.root:'nominal SFs (offline values)':600:1:24 \
      ./tuning_test_applyPUCorr_False_tunedSFs/harvester_output/HLT_Run3TRK/MinNeutralPt_0.0/MinNeutralPtSlope_0.0/Run3Winter21_VBF_HToInvisible_14TeV_PU__0.root:'mean values SFs':632:1:25 \
      ./tuning_test_optimizedChi2_minChi2/harvester_output/HLT_Run3TRK/MinNeutralPt_0.0/MinNeutralPtSlope_0.0/Run3Winter21_VBF_HToInvisible_14TeV_PU__0.root:'per particle optimized SFs':814:1:26 \
