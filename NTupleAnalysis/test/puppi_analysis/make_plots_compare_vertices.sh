...
ODIR=./tuning_compare_vertices/plots
...
for recoKey in "${recoKeys[@]}"; do
  for MinNeutralPt_factor in  "${MinNeutralPt_factors[@]}"; do
    for MinNeutralPtSlope_factor in "${MinNeutralPtSlope_factors[@]}"; do
      ...
      ./tuning_old_vertex/harvester_output/HLT_Run3TRK/MinNeutralPt_${MinNeutralPt_factor}/MinNeutralPtSlope_${MinNeutralPtSlope_factor}/Run3Winter21_QCD_Pt15to7000_14TeV_PU__0.root:'PF vertices+PixelClusters proxy':416:1:24 \
      ./tuning_new_vertex/harvester_output/HLT_Run3TRK/MinNeutralPt_${MinNeutralPt_factor}/MinNeutralPtSlope_${MinNeutralPtSlope_factor}/Run3Winter21_QCD_Pt15to7000_14TeV_PU__0.root:'Pixel vertices (also proxy)':632:1:24 \
      ./tuning_new_vertex_old_proxy_v3/harvester_output/HLT_Run3TRK/MinNeutralPt_${MinNeutralPt_factor}/MinNeutralPtSlope_${MinNeutralPtSlope_factor}/Run3Winter21_QCD_Pt15to7000_14TeV_PU__0.root:'Pixel vertices+PixelClusters proxy':904:1:24 \
      ...
      ./tuning_old_vertex/harvester_output/HLT_Run3TRK/MinNeutralPt_${MinNeutralPt_factor}/MinNeutralPtSlope_${MinNeutralPtSlope_factor}/Run3Winter21_VBF_HToInvisible_14TeV_PU__0.root:'PF vertices+PixelClusters proxy':416:1:24 \
      ./tuning_new_vertex/harvester_output/HLT_Run3TRK/MinNeutralPt_${MinNeutralPt_factor}/MinNeutralPtSlope_${MinNeutralPtSlope_factor}/Run3Winter21_VBF_HToInvisible_14TeV_PU__0.root:'Pixel vertices (also proxy)':632:1:24 \
      ./tuning_new_vertex_old_proxy_v3/harvester_output/HLT_Run3TRK/MinNeutralPt_${MinNeutralPt_factor}/MinNeutralPtSlope_${MinNeutralPtSlope_factor}/Run3Winter21_VBF_HToInvisible_14TeV_PU__0.root:'Pixel vertices+PixelClusters proxy':904:1:24 \
