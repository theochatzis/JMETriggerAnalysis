...
ODIR=./tuning_test_newSFs_nominal_FixedBackupDist_PUfitNew/plots
...
for recoKey in "${recoKeys[@]}"; do
  for MinNeutralPt_factor in  "${MinNeutralPt_factors[@]}"; do
    for MinNeutralPtSlope_factor in "${MinNeutralPtSlope_factors[@]}"; do
      ...
      ./tuning_test_newSFs_nominal_FixedBackupDist_PUfitNew_A0/harvester_output/HLT_Run3TRK/MinNeutralPt_0.0/MinNeutralPtSlope_0.0/Run3Winter21_QCD_Pt15to7000_14TeV_PU__0.root:'hybrid method, no offset':416:1:26 \
      ...
      ./tuning_test_newSFs_nominal_FixedBackupDist_PUfitNew_A0/harvester_output/HLT_Run3TRK/MinNeutralPt_0.0/MinNeutralPtSlope_0.0/Run3Winter21_VBF_HToInvisible_14TeV_PU__0.root:'hybrid method, no offset':416:1:26 \
