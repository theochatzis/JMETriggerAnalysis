...
ODIR=./tuning_test_newSFs_nominal_tunings_calib/plots
...
for recoKey in "${recoKeys[@]}"; do
  for MinNeutralPt_factor in  "${MinNeutralPt_factors[@]}"; do
    for MinNeutralPtSlope_factor in "${MinNeutralPtSlope_factors[@]}"; do
      ...
      ./tuning_test_newSFs_nominal_tuned_withoutPUtracks_calib/harvester_output/HLT_Run3TRK/MinNeutralPt_0.0/MinNeutralPtSlope_0.0/Run3Winter21_QCD_Pt15to7000_14TeV_PU__0.root:'tuned AB':616:1:25 \
      ./tuning_test_newSFs_nominal_FixedBackupDist_PUfitNew_tuned_withPUtracks_calib_noPUtracks/harvester_output/HLT_Run3TRK/MinNeutralPt_0.0/MinNeutralPtSlope_0.0/Run3Winter21_QCD_Pt15to7000_14TeV_PU__0.root:'offline MedRMS + tuned AB':800:1:25 \
      ...
      ./tuning_test_newSFs_nominal_tuned_withoutPUtracks_calib/harvester_output/HLT_Run3TRK/MinNeutralPt_0.0/MinNeutralPtSlope_0.0/Run3Winter21_VBF_HToInvisible_14TeV_PU__0.root:'tuned AB':616:1:25 \
      ./tuning_test_newSFs_nominal_FixedBackupDist_PUfitNew_tuned_withPUtracks_calib_noPUtracks/harvester_output/HLT_Run3TRK/MinNeutralPt_0.0/MinNeutralPtSlope_0.0/Run3Winter21_VBF_HToInvisible_14TeV_PU__0.root:'offline MedRMS + tuned AB':800:1:25 \
      ...
      -i ./tuning_test_newSFs_nominal/harvester_output/HLT_Run3TRK/MinNeutralPt_0.0/MinNeutralPtSlope_0.0/Run3Winter21_QCD_Pt15to7000_14TeV_PU__0.root:'nominal AB':600:1:24 \
      ./tuning_test_newSFs_nominal_tuned_withPUtracks_calib/harvester_output/HLT_Run3TRK/MinNeutralPt_0.0/MinNeutralPtSlope_0.0/Run3Winter21_QCD_Pt15to7000_14TeV_PU__0.root:'tuned AB':616:1:25 \
      ./tuning_test_newSFs_nominal_FixedBackupDist_PUfitNew_tuned_withPUtracks_calib_withPUtracks/harvester_output/HLT_Run3TRK/MinNeutralPt_0.0/MinNeutralPtSlope_0.0/Run3Winter21_QCD_Pt15to7000_14TeV_PU__0.root:'offline MedRMS + tuned AB':800:1:25 \
      ...
      -i ./tuning_test_newSFs_nominal/harvester_output/HLT_Run3TRK/MinNeutralPt_0.0/MinNeutralPtSlope_0.0/Run3Winter21_VBF_HToInvisible_14TeV_PU__0.root:'nominal AB':600:1:24 \
      ./tuning_test_newSFs_nominal_tuned_withPUtracks_calib/harvester_output/HLT_Run3TRK/MinNeutralPt_0.0/MinNeutralPtSlope_0.0/Run3Winter21_VBF_HToInvisible_14TeV_PU__0.root:'tuned AB':616:1:25 \
      ./tuning_test_newSFs_nominal_FixedBackupDist_PUfitNew_tuned_withPUtracks_calib_withPUtracks/harvester_output/HLT_Run3TRK/MinNeutralPt_0.0/MinNeutralPtSlope_0.0/Run3Winter21_VBF_HToInvisible_14TeV_PU__0.root:'offline MedRMS + tuned AB':800:1:25 \
