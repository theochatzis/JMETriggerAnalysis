...
ODIR=./tuning_test_newSFs_nominal_increase_B_compare/plots
...
for recoKey in "${recoKeys[@]}"; do
  for MinNeutralPt_factor in  "${MinNeutralPt_factors[@]}"; do
    for MinNeutralPtSlope_factor in "${MinNeutralPtSlope_factors[@]}"; do
      ...
      ./tuning_test_newSFs_nominal_increase_B/harvester_output/HLT_Run3TRK/MinNeutralPt_1.0/MinNeutralPtSlope_5.0/Run3Winter21_QCD_Pt15to7000_14TeV_PU__0.root:'5 x B':861:1:25 \
      ./tuning_test_newSFs_nominal_increase_B/harvester_output/HLT_Run3TRK/MinNeutralPt_1.0/MinNeutralPtSlope_10.0/Run3Winter21_QCD_Pt15to7000_14TeV_PU__0.root:'10 x B':874:1:25 \
      ./tuning_test_newSFs_nominal_increase_B/harvester_output/HLT_Run3TRK/MinNeutralPt_1.0/MinNeutralPtSlope_15.0/Run3Winter21_QCD_Pt15to7000_14TeV_PU__0.root:'15 x B':904:1:25 \
      ./tuning_test_newSFs_nominal_increase_B/harvester_output/HLT_Run3TRK/MinNeutralPt_1.0/MinNeutralPtSlope_20.0/Run3Winter21_QCD_Pt15to7000_14TeV_PU__0.root:'20 x B':807:1:25 \
      ./tuning_test_newSFs_nominal_increase_B/harvester_output/HLT_Run3TRK/MinNeutralPt_1.0/MinNeutralPtSlope_25.0/Run3Winter21_QCD_Pt15to7000_14TeV_PU__0.root:'25 x B':814:1:25 \
