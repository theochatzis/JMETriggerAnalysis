...
JMETriggerAnalysisDriverPhase2::JMETriggerAnalysisDriverPhase2(const std::string& tfile,
...
JMETriggerAnalysisDriverPhase2::JMETriggerAnalysisDriverPhase2(const std::string& outputFilePath,
                                                               const std::string& outputFileMode)
...
bool JMETriggerAnalysisDriverPhase2::jetBelongsToCategory(const std::string& jetCollection,
  ...
  else if (categLabel == "_Eta2p4") {
    ret = (jetAbsEta < 2.4);
  } else if (categLabel == "_Eta2p4Pt0") {
    ret = (jetAbsEta < 2.4) and (30. <= jetPt) and (jetPt < 60.);
  } else if (categLabel == "_Eta2p4Pt1") {
    ret = (jetAbsEta < 2.4) and (60. <= jetPt) and (jetPt < 110.);
  } else if (categLabel == "_Eta2p4Pt2") {
    ret = (jetAbsEta < 2.4) and (110. <= jetPt) and (jetPt < 400.);
  } else if (categLabel == "_Eta2p4Pt3") {
    ret = (jetAbsEta < 2.4) and (400. <= jetPt) and (jetPt < 2000.);
  } else if (categLabel == "_Eta2p4Pt4") {
    ret = (jetAbsEta < 2.4) and (2000. <= jetPt);
  }

  else if (categLabel == "_HB") {
    ret = (jetAbsEta < 1.5);
  } else if (categLabel == "_HBPt0") {
    ret = (jetAbsEta < 1.5) and (30. <= jetPt) and (jetPt < 60.);
  } else if (categLabel == "_HBPt1") {
    ret = (jetAbsEta < 1.5) and (60. <= jetPt) and (jetPt < 110.);
  } else if (categLabel == "_HBPt2") {
    ret = (jetAbsEta < 1.5) and (110. <= jetPt) and (jetPt < 400.);
  } else if (categLabel == "_HBPt3") {
    ret = (jetAbsEta < 1.5) and (400. <= jetPt) and (jetPt < 2000.);
  } else if (categLabel == "_HBPt4") {
    ret = (jetAbsEta < 1.5) and (2000. <= jetPt);
  }

  else if (categLabel == "_HGCal") {
    ret = (1.5 <= jetAbsEta) and (jetAbsEta < 3.0);
  } else if (categLabel == "_HGCalPt0") {
    ret = (1.5 <= jetAbsEta) and (jetAbsEta < 3.0) and (30. <= jetPt) and (jetPt < 60.);
  } else if (categLabel == "_HGCalPt1") {
    ret = (1.5 <= jetAbsEta) and (jetAbsEta < 3.0) and (60. <= jetPt) and (jetPt < 110.);
  } else if (categLabel == "_HGCalPt2") {
    ret = (1.5 <= jetAbsEta) and (jetAbsEta < 3.0) and (110. <= jetPt) and (jetPt < 400.);
  } else if (categLabel == "_HGCalPt3") {
    ret = (1.5 <= jetAbsEta) and (jetAbsEta < 3.0) and (400. <= jetPt) and (jetPt < 2000.);
  } else if (categLabel == "_HGCalPt4") {
    ret = (1.5 <= jetAbsEta) and (jetAbsEta < 3.0) and (2000. <= jetPt);
  }

  else if (categLabel == "_HGCalToHF") {
    ret = (2.8 <= jetAbsEta) and (jetAbsEta < 3.2);
  } else if (categLabel == "_HGCalToHFPt0") {
    ret = (2.8 <= jetAbsEta) and (jetAbsEta < 3.2) and (30. <= jetPt) and (jetPt < 60.);
  } else if (categLabel == "_HGCalToHFPt1") {
    ret = (2.8 <= jetAbsEta) and (jetAbsEta < 3.2) and (60. <= jetPt) and (jetPt < 110.);
  } else if (categLabel == "_HGCalToHFPt2") {
    ret = (2.8 <= jetAbsEta) and (jetAbsEta < 3.2) and (110. <= jetPt) and (jetPt < 400.);
  } else if (categLabel == "_HGCalToHFPt3") {
    ret = (2.8 <= jetAbsEta) and (jetAbsEta < 3.2) and (400. <= jetPt) and (jetPt < 2000.);
  } else if (categLabel == "_HGCalToHFPt4") {
    ret = (2.8 <= jetAbsEta) and (jetAbsEta < 3.2) and (2000. <= jetPt);
  }
  ...
  else if (categLabel == "_HF1") {
    ret = (3.0 <= jetAbsEta) and (jetAbsEta < 4.0);
  } else if (categLabel == "_HF1Pt0") {
    ret = (3.0 <= jetAbsEta) and (jetAbsEta < 4.0) and (30. <= jetPt) and (jetPt < 60.);
  } else if (categLabel == "_HF1Pt1") {
    ret = (3.0 <= jetAbsEta) and (jetAbsEta < 4.0) and (60. <= jetPt) and (jetPt < 110.);
  } else if (categLabel == "_HF1Pt2") {
    ret = (3.0 <= jetAbsEta) and (jetAbsEta < 4.0) and (110. <= jetPt) and (jetPt < 400.);
  } else if (categLabel == "_HF1Pt3") {
    ret = (3.0 <= jetAbsEta) and (jetAbsEta < 4.0) and (400. <= jetPt) and (jetPt < 2000.);
  } else if (categLabel == "_HF1Pt4") {
    ret = (3.0 <= jetAbsEta) and (jetAbsEta < 4.0) and (2000. <= jetPt);
  }

  else if (categLabel == "_HF2") {
    ret = (4.0 <= jetAbsEta) and (jetAbsEta < 5.0);
  } else if (categLabel == "_HF2Pt0") {
    ret = (4.0 <= jetAbsEta) and (jetAbsEta < 5.0) and (30. <= jetPt) and (jetPt < 60.);
  } else if (categLabel == "_HF2Pt1") {
    ret = (4.0 <= jetAbsEta) and (jetAbsEta < 5.0) and (60. <= jetPt) and (jetPt < 110.);
  } else if (categLabel == "_HF2Pt2") {
    ret = (4.0 <= jetAbsEta) and (jetAbsEta < 5.0) and (110. <= jetPt) and (jetPt < 400.);
  } else if (categLabel == "_HF2Pt3") {
    ret = (4.0 <= jetAbsEta) and (jetAbsEta < 5.0) and (400. <= jetPt) and (jetPt < 2000.);
  } else if (categLabel == "_HF2Pt4") {
    ret = (4.0 <= jetAbsEta) and (jetAbsEta < 5.0) and (2000. <= jetPt);
  }
...
void JMETriggerAnalysisDriverPhase2::init() {
  ...
  l1tSeeds_1Jet_ = {
      "L1T_SinglePFPuppiJet200off", "L1T_SinglePFPuppiJet200off2", "L1T_SinglePFPuppiJet230off2",
  ...
  l1tSeeds_MET_ = {
      "L1T_PFPuppiMET200off", "L1T_PFPuppiMET200off2", "L1T_PFPuppiMET220off2",
  ...
  for (auto const& jetLabel : labelMap_jetAK4_) {
    ...
    for (auto const& jetLabelRefs : jetLabel.second) {
      fhDataAK4Jets.matches.emplace_back(
          fillHistoDataJets::Match(jetLabelRefs.first, jetLabelRefs.second, jetPt2, maxAK4JetDeltaRmatchRef));
    }

    fillHistograms_Jets("NoSelection", fhDataAK4Jets, wgt);

    if (jetLabel.first.find("l1t") == 0)
      continue;
  ...
  for (auto const& jetLabel : labelMap_jetAK8_) {
    ...
    for (auto const& jetLabelRefs : jetLabel.second) {
      fhDataAK8Jets.matches.emplace_back(
          fillHistoDataJets::Match(jetLabelRefs.first, jetLabelRefs.second, jetPt2, maxAK8JetDeltaRmatchRef));
    }
...
void JMETriggerAnalysisDriverPhase2::bookHistograms_Jets_2DMaps(const std::string& dir,
...
void JMETriggerAnalysisDriverPhase2::bookHistograms_MET_2DMaps(const std::string& dir,
...
void JMETriggerAnalysisDriverPhase2::fillHistograms_Jets_2DMaps(const std::string& dir,
  ...
  if (not(v_pt1 and v_eta1)) {
    if (verbosity_ >= 0) {
      std::cout << "JMETriggerAnalysisDriverPhase2::fillHistograms_Jets_2DMaps(\"" << dir
                << "\", const fillHistoDataJets&, const fillHistoDataJets&) -- "
                << "branches not available (histograms will not be filled): " << fhData1.jetCollection + "_pt/eta"
                << std::endl;
    }
    return;
  }
  ...
  if (not(v_pt2 and v_eta2)) {
    if (verbosity_ >= 0) {
      std::cout << "JMETriggerAnalysisDriverPhase2::fillHistograms_Jets_2DMaps(\"" << dir
                << "\", const fillHistoDataJets&, const fillHistoDataJets&) -- "
                << "branches not available (histograms will not be filled): " << fhData2.jetCollection + "_pt/eta"
                << std::endl;
    }
    return;
  }
...
void JMETriggerAnalysisDriverPhase2::fillHistograms_MET_2DMaps(const std::string& dir,
  ...
  if (not v_pt1) {
    if (verbosity_ >= 0) {
      std::cout << "JMETriggerAnalysisDriverPhase2::fillHistograms_MET_2DMaps(\"" << dir
                << "\", const fillHistoDataMET&, const fillHistoDataMET&) -- "
                << "branches not available (histograms will not be filled): " << fhData1.metCollection + "_pt"
                << std::endl;
    }
    return;
    ...
    if (verbosity_ >= 0) {
      std::cout << "JMETriggerAnalysisDriverPhase2::fillHistograms_MET_2DMaps(\"" << dir
                << "\", const fillHistoDataMET&, const fillHistoDataMET&) -- "
                << "MET branches have invalid size (histograms will not be filled): " << fhData1.metCollection + "_pt"
                << std::endl;
    }
    return;
  }
  ...
  if (not v_pt2) {
    if (verbosity_ >= 0) {
      std::cout << "JMETriggerAnalysisDriverPhase2::fillHistograms_MET_2DMaps(\"" << dir
                << "\", const fillHistoDataMET&, const fillHistoDataMET&) -- "
                << "branches not available (histograms will not be filled): " << fhData2.metCollection + "_pt"
                << std::endl;
    }
    return;
    ...
    if (verbosity_ >= 0) {
      std::cout << "JMETriggerAnalysisDriverPhase2::fillHistograms_MET_2DMaps(\"" << dir
                << "\", const fillHistoDataMET&, const fillHistoDataMET&) -- "
                << "MET branches have invalid size (histograms will not be filled): " << fhData2.metCollection + "_pt"
                << std::endl;
    }
    return;
  }
  ...
  H2(dirPrefix + fhData1.metCollection + "_phi__vs__" + fhData2.metCollection + "_phi")
      ->Fill(met1_phi, met2_phi, weight);
  H2(dirPrefix + fhData1.metCollection + "_sumEt__vs__" + fhData2.metCollection + "_sumEt")
      ->Fill(met1_sumEt, met2_sumEt, weight);
}
...
void JMETriggerAnalysisDriverPhase2::bookHistograms_METMHT(const std::string& dir) {
  ...
  for (uint idx = 0; idx < binEdges_pt_2.size(); ++idx) {
    binEdges_pt_2.at(idx) = 80. + idx * 5.;
  }
  ...
  addTH3D(dirPrefix + "genMETTrue_pt__vs__hltPFPuppiMETTypeOne_pt__vs__hltPFPuppiMHT20_pt",
          binEdges_pt,
          binEdges_pt_2,
          binEdges_pt_2);
  addTH3D(dirPrefix + "genMETTrue_pt__vs__hltPFPuppiMETTypeOne_pt__vs__hltPFPuppiMHT30_pt",
          binEdges_pt,
          binEdges_pt_2,
          binEdges_pt_2);
  addTH3D(dirPrefix + "genMETTrue_pt__vs__hltPFPuppiMETTypeOne_pt__vs__hltPFPuppiMHT40_pt",
          binEdges_pt,
          binEdges_pt_2,
          binEdges_pt_2);
  addTH3D(dirPrefix + "genMETTrue_pt__vs__hltPFPuppiMETTypeOne_pt__vs__hltPFPuppiMHT50_pt",
          binEdges_pt,
          binEdges_pt_2,
          binEdges_pt_2);
...
void JMETriggerAnalysisDriverPhase2::fillHistograms_METMHT(const std::string& dir, float const weight) {
  ...
  H3(dirPrefix + "genMETTrue_pt__vs__hltPFPuppiMETTypeOne_pt__vs__hltPFPuppiMHT20_pt")
      ->Fill(genMETTrue_pt, hltPFPuppiMETTypeOne_pt, hltPFPuppiMHT20_pt, weight);
  H3(dirPrefix + "genMETTrue_pt__vs__hltPFPuppiMETTypeOne_pt__vs__hltPFPuppiMHT30_pt")
      ->Fill(genMETTrue_pt, hltPFPuppiMETTypeOne_pt, hltPFPuppiMHT30_pt, weight);
  H3(dirPrefix + "genMETTrue_pt__vs__hltPFPuppiMETTypeOne_pt__vs__hltPFPuppiMHT40_pt")
      ->Fill(genMETTrue_pt, hltPFPuppiMETTypeOne_pt, hltPFPuppiMHT40_pt, weight);
  H3(dirPrefix + "genMETTrue_pt__vs__hltPFPuppiMETTypeOne_pt__vs__hltPFPuppiMHT50_pt")
      ->Fill(genMETTrue_pt, hltPFPuppiMETTypeOne_pt, hltPFPuppiMHT50_pt, weight);
  H2(dirPrefix + "hltPFPuppiMETTypeOne_pt__vs__hltPFPuppiMHT20_pt")
      ->Fill(hltPFPuppiMETTypeOne_pt, hltPFPuppiMHT20_pt, weight);
  H2(dirPrefix + "hltPFPuppiMETTypeOne_pt__vs__hltPFPuppiMHT30_pt")
      ->Fill(hltPFPuppiMETTypeOne_pt, hltPFPuppiMHT30_pt, weight);
  H2(dirPrefix + "hltPFPuppiMETTypeOne_pt__vs__hltPFPuppiMHT40_pt")
      ->Fill(hltPFPuppiMETTypeOne_pt, hltPFPuppiMHT40_pt, weight);
  H2(dirPrefix + "hltPFPuppiMETTypeOne_pt__vs__hltPFPuppiMHT50_pt")
      ->Fill(hltPFPuppiMETTypeOne_pt, hltPFPuppiMHT50_pt, weight);
}
...
bool JMETriggerAnalysisDriverPhase2::l1tSingleJetSeed(std::string const& key) const {
  ...
  float offlinePt(0.f);
  if (std::abs(eta) < 1.5)
    offlinePt = 1.40627 * pt + 11.1254;
  else if (std::abs(eta) < 2.4)
    offlinePt = 1.4152 * pt + 24.8375;
  else
    offlinePt = 1.33052 * pt + 42.4039;

  if (key == "L1T_SinglePFPuppiJet200off2")
    return offlinePt > 200.;
  else if (key == "L1T_SinglePFPuppiJet230off2")
    return offlinePt > 230.;
  else if (key == "L1T_SinglePFPuppiJet280off2")
    return offlinePt > 280.;
  else if (key == "L1T_SinglePFPuppiJet320off2")
    return offlinePt > 320.;
  else if (key == "L1T_SinglePFPuppiJet350off2")
    return offlinePt > 350.;
  else if (key == "L1T_SinglePFPuppiJet380off2")
    return offlinePt > 380.;
  else if (key == "L1T_SinglePFPuppiJet400off2")
    return offlinePt > 400.;
  else if (key == "L1T_SinglePFPuppiJet420off2")
    return offlinePt > 420.;
  else
...
bool JMETriggerAnalysisDriverPhase2::l1tHTSeed(std::string const& key) const {
  ...
  if (key == "L1T_PFPuppiHT450off2")
    return offlineHT > 450.;
  else if (key == "L1T_PFPuppiHT500off2")
    return offlineHT > 500.;
  else if (key == "L1T_PFPuppiHT550off2")
    return offlineHT > 550.;
  else if (key == "L1T_PFPuppiHT600off2")
    return offlineHT > 600.;
  else if (key == "L1T_PFPuppiHT650off2")
    return offlineHT > 650.;
  else if (key == "L1T_PFPuppiHT700off2")
    return offlineHT > 700.;
  else if (key == "L1T_PFPuppiHT750off2")
    return offlineHT > 750.;
  else if (key == "L1T_PFPuppiHT800off2")
    return offlineHT > 800.;
  else
...
bool JMETriggerAnalysisDriverPhase2::l1tMETSeed(std::string const& key) const {
  ...
  if (key == "L1T_PFPuppiMET200off2")
    return offlineMET > 200.;
  else if (key == "L1T_PFPuppiMET220off2")
    return offlineMET > 220.;
  else if (key == "L1T_PFPuppiMET250off2")
    return offlineMET > 250.;
  else
...
*/
  ...
  for (size_t jetIdx = 0; jetIdx < v_pt.size(); ++jetIdx) {
    if (std::abs(v_eta.at(jetIdx)) >= jetAbsEtaMax)
      continue;
    /*
...
*/
    ...
    auto const jetPtMin_new =
        jetPtMin;  //!! (std::abs(p4polar.Eta()) < 2.95 or std::abs(p4polar.Eta()) > 3.05) ? jetPtMin : std::max(60.f, jetPtMin);
