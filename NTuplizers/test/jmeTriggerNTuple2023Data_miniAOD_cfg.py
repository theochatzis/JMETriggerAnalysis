...
if not opts.isMuonData:
    ...
    hltPathsWithTriggerFlags = [
      ...
      ['HLT_PFJet320','HLT_PFJet200'],
      ['HLT_PFJet320','HLT_PFJet260'],
      ['HLT_PFJet500','HLT_PFJet320'],
      ['HLT_PFJet500','HLT_PFJet400'],
      ['HLT_PFJet500','HLT_PFJet450'],
      #['HLT_PFJet60','HLT_PFJet40'],
      #['HLT_PFJet80','HLT_PFJet60'],
      #['HLT_PFJet110','HLT_PFJet80'],
      #['HLT_PFJet140','HLT_PFJet110'],
      #['HLT_PFJet200','HLT_PFJet140'],
      #['HLT_PFJet260','HLT_PFJet200'],
      #['HLT_PFJet320','HLT_PFJet260'],
      #['HLT_PFJet400','HLT_PFJet320'],
      #['HLT_PFJet450','HLT_PFJet400'],
      #['HLT_PFJet500','HLT_PFJet450'],
      # Forward
      ['HLT_PFJetFwd60','HLT_PFJetFwd40'],
      ['HLT_PFJetFwd140','HLT_PFJetFwd40'],
      ['HLT_PFJetFwd140','HLT_PFJetFwd60'],
      ['HLT_PFJetFwd140','HLT_PFJetFwd80'],
      ['HLT_PFJetFwd320','HLT_PFJetFwd140'],
      ['HLT_PFJetFwd320','HLT_PFJetFwd200'],
      ['HLT_PFJetFwd320','HLT_PFJetFwd260'],
      ['HLT_PFJetFwd500','HLT_PFJetFwd320'],
      ['HLT_PFJetFwd500','HLT_PFJetFwd400'],
      ['HLT_PFJetFwd500','HLT_PFJetFwd450'],
      #['HLT_PFJetFwd60','HLT_PFJetFwd40'],
      #['HLT_PFJetFwd80','HLT_PFJetFwd60'],
      #['HLT_PFJetFwd140','HLT_PFJetFwd80'],
      #['HLT_PFJetFwd200','HLT_PFJetFwd140'],
      #['HLT_PFJetFwd260','HLT_PFJetFwd200'],
      #['HLT_PFJetFwd320','HLT_PFJetFwd260'],
      #['HLT_PFJetFwd400','HLT_PFJetFwd320'],
      #['HLT_PFJetFwd450','HLT_PFJetFwd400'],
      #['HLT_PFJetFwd500','HLT_PFJetFwd450'],
      # HT
      ['HLT_PFHT370','HLT_PFHT180'],
      ['HLT_PFHT370','HLT_PFHT250'],
      ['HLT_PFHT370','HLT_PFHT350'],
      ['HLT_PFHT780','HLT_PFHT510'],
      ['HLT_PFHT780','HLT_PFHT590'],
      ['HLT_PFHT780','HLT_PFHT680'],
      ['HLT_PFHT1050','HLT_PFHT680'],
      ['HLT_PFHT1050','HLT_PFHT780'],
      ['HLT_PFHT1050','HLT_PFHT890'],
      #['HLT_PFHT250','HLT_PFHT180'],
      #['HLT_PFHT350','HLT_PFHT250'],
      #['HLT_PFHT370','HLT_PFHT350'],
      #['HLT_PFHT430','HLT_PFHT370'],
      #['HLT_PFHT510','HLT_PFHT430'],
      #['HLT_PFHT590','HLT_PFHT510'],
      #['HLT_PFHT680','HLT_PFHT590'],
      #['HLT_PFHT780','HLT_PFHT680'],
      #['HLT_PFHT890','HLT_PFHT780'],
      #['HLT_PFHT1050','HLT_PFHT890'],
    ]
