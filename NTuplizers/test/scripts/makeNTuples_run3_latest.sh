...
# QCD 
samplesMap["Run3Winter23_QCD_Pt15to7000_13p6TeV_PU65"]='/QCD_PT-15to7000_TuneCP5_13p6TeV_pythia8/Run3Winter23MiniAOD-FlatPU0to120_126X_mcRun3_2023_forPU65_v1-v2/MINIAODSIM'
...
for recoKey in "${recoKeys[@]}"; do
  ...
  for sampleKey in ${!samplesMap[@]}; do
    ...
    bdriver -c .tmp_cfg.py --customize-cfg -m ${numEvents} -n 100 --memory 2G --time 02:00:00 \
