...
python ${CMSSW_BASE}/src/JMETriggerAnalysis/NTuplizers/test/jmeTriggerNTuple_cfg.py dumpPython=.tmp_cfg.py numThreads=1
for sampleKey in ${!samplesMap[@]}; do
  ...
  bdriver -c .tmp_cfg.py --customize-cfg -m ${numEvents} -n -1 --cpus 1 --memory 2G --time 01:30:00 ${opts} --batch-system htc \
